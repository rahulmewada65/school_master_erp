...
import 'package:school_master_erp/services/subject_api_service.dart';
...
class ExampleSource extends AdvancedDataTableSource<subjectModal> {
  ...
  @override
  Future<RemoteDataSourceDetails<subjectModal>> getNextPage(
     ...
     // print(data);
      ...
      return RemoteDataSourceDetails(
        ...
        (data as List<dynamic>)
            .map(
              (json) => subjectModal.fromJson(json as Map<String, dynamic>),
            )
            .toList(),
