                                        ...
                                        child: Padding(
                                          ...
                                          child: SizedBox(
                                            ...
                                            child: IconButton(
                                              ...
                                              tooltip: 'Add New Exam Element',
                                              onPressed: () =>
                                                  GoRouter.of(context).go(RouteUri.add_exam),
                                            ),
                                          ),
                                        ),
                                      ),
...
class ExampleSource extends AdvancedDataTableSource<ExamModal> {
  ...
  Future<void> doOperations(
    ...
    if (operationType == 'EDIT') {
      GoRouter.of(context).go('${RouteUri.exam_profile}?id=$id');
      // print('EDIT');
    }
  ...
  @override
  Future<RemoteDataSourceDetails<ExamModal>> getNextPage(
    ...
    final response = await apiService.getExamList();
    if (response.statusCode == 200) {
      final data = jsonDecode(response.body);
      print(data);
      var le = data['rows'].length;
      return RemoteDataSourceDetails(
        int.parse(le.toString()),
        (data['rows'] as List<dynamic>)
            .map(
              (json) => ExamModal.fromJson(json as Map<String, dynamic>),
            )
            .toList(),
