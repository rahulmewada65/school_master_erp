...
class ExampleSource extends AdvancedDataTableSource<CompanyContact> {
    ...
    final dialog = AwesomeDialog(
      ...
      btnOkOnPress: () {
        final d = AwesomeDialog(
          ...
          width: kDialogWidth,
          btnOkText: 'OK',
          btnOkOnPress:(){ apiService.deletefeesElementRow(id).whenComplete(() => setNextView());},
        );
        d.show();
      },
  ...
  Future<RemoteDataSourceDetails<CompanyContact>> getNextPage(
    ...
    final response = await apiService.getFeesElementList(queryParameter);
