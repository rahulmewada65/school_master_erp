...
class _ClassScreenState extends State<ClassScreen> {
  ...
  final ClassApiService apiService = ClassApiService();
...
class ExampleSource extends AdvancedDataTableSource<ClassModal> {
    ...
    final dialog = AwesomeDialog(
      ...
      btnOkOnPress: () {
        final d = AwesomeDialog(
          ...
          btnOkText: 'OK',
          btnOkOnPress: () {
            apiService.deleteClass(id).whenComplete(() => setNextView());
          },
        );
        d.show();
      },
  ...
  @override
  Future<RemoteDataSourceDetails<ClassModal>> getNextPage(
    ...
    final response = await apiService.getClassList();
    ...
    if (response.statusCode == 200) {
      ...
      return RemoteDataSourceDetails(
        ...
        (data as List<dynamic>)
            .map(
              (json) => ClassModal.fromJson(json as Map<String, dynamic>),
            )
            .toList(),
